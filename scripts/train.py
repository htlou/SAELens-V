...
cfg = LanguageModelSAERunnerConfig(
    ...
    model_name="htlou/AA-Chameleon-7B-plus",  # our model (more options here: https://neelnanda-io.github.io/TransformerLens/generated/model_properties_table.html)
    local_model_path="/aifs4su/yaodong/models/Anole-7b-v0.1-hf",
