...
def process_task(task_name, config, topk_range):
    ...
    # get model
    model_1 = HookedTransformer.from_pretrained("gemma-2b-it", hf_model = local_model, device=device[1])
...
def plot_results(results, topk_range):
    ...
    plt.savefig("outputs/figures/gemma_mean_change.pdf")
...
def main():
    ...
    with open("outputs/raw/results_gemma.pkl", "wb") as f:
