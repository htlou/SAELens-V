...
tasks = {
    "safety": {
        ...
        "model_path": "/aifs4su/yaodong/projects/hantao/personal/models/output_gemma_it_sft0716",
    },
    "math": {
...
def task(data, template, model_0, sae_0, hook_point_0, model_1, sae_1, hook_point_1, topn):
...
def process_task(task_name, config):
    ...
    # get model
    model = HookedTransformer.from_pretrained("gemma-2b-it", hf_model = local_model, device=device[1])
...
def main():
    ...
    file_name = f"outputs/gemma_output_top_{args.topk}.csv"
