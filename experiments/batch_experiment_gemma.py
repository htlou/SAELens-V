...
tasks = {
    "math": {
        ...
        "model_path": "/aifs4su/yaodong/projects/hantao/personal/models/0813/0814_output_gemma-2b-it_MATH_cor_sft",
        "device": "cuda:2"
    },
    "reasoning": {
        "dataset": "/aifs4su/yaodong/projects/hantao/personal/data/reasoning_700.json",
        "general": "/aifs4su/yaodong/projects/hantao/personal/data/base_700.json",
        "model_path": "/aifs4su/yaodong/projects/hantao/personal/models/0813/0814_output_gemma-2b-it_reasoning_cor_sft",
        "device": "cuda:2"
    },
    "empathy": {
        "dataset": "/aifs4su/yaodong/projects/hantao/personal/data/empathy_700.json",
        "general": "/aifs4su/yaodong/projects/hantao/personal/data/base_700.json",
        "model_path": "/aifs4su/yaodong/projects/hantao/personal/models/0813/0814_output_gemma-2b-it_empathy_cor_sft",
        "device": "cuda:2"
    },
    "chinese": {
        "dataset": "/aifs4su/yaodong/projects/hantao/personal/data/zh_700.json",
        "general": "/aifs4su/yaodong/projects/hantao/personal/data/base_700.json",
        "model_path": "/aifs4su/yaodong/projects/hantao/personal/models/0813/0814_output_gemma-2b-it_alpaca_zh_sft",
        "device": "cuda:2"
    }
}

def task(data, template, model_0, sae_0, hook_point_0, model_1, sae_1, hook_point_1, topn=5):
    ...
    for piece in data:
        ...
        topk1 = torch.topk(sv_feature_acts_0, topn)
        ...
        # print out the top activations, focus on the indices
        topk2 = torch.topk(sv_feature_acts_1, topn)
...
def process_task(task_name, config):
    ...
    # get model
    model = HookedTransformer.from_pretrained("gemma-2b-it", hf_model = local_model, device=config["device"])
    ...
    intersection_mean, intersection_variance, value_changes_mean, value_changes_variance = task(task_data, template, model_0, sae_0, hook_point_0, model, sae_1, hook_point_1, topn=5)

    # general data 
    intersection_mean_general, intersection_variance_general, value_changes_mean_general, value_changes_variance_general = task(general_data, template, model_0, sae_0, hook_point_0, model, sae_1, hook_point_1, topn=5)
...
final_df.to_csv("outputs/gemma_output.csv", index=False)
print("Saved all task results to 'task_output.csv'")
